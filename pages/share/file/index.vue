    ...
    <div class="w-[90%] xl:w-[80%] h-full flex flex-col items-start gap-6">
          ...
          <div class="flex flex-row gap-4 items-center">
            ...
            >
              <Icon
                ...
                class="size-5"
              /><span class="text-xl font-bold">Your File List</span>
            </div>
            <Badge
            v-if="!userAuthed"
              ><Icon
              ...
              /><span class="cursor-default">Anonymouse&nbsp;Mode</span>
            </Badge>
          </div>
          <div
      ...
      >
        <div
          ...
          class="w-full h-12 flex justify-center items-center absolute"
        >
          <LoadingCycle />
        </div>
        <button
        ...
        >
          <Icon
          v-if="listStatus !== 'pending'"
            name="mdi:cloud-arrow-down-outline"
          />
