    ...
    "56d7": function(t, e, n) {
        ...
        var i = n("c579"),
            ...
            E = function() {
                ...
                }, [t._v("白嫖")]), t._v("直接使用 Pages 服务部署。")]), i("p", [t._v("它是神代大佬学习 Vue.js 的副产物，顺便想看看仅靠在客户端上运行 JavaScript 到底能做多少事情，仅此而已。")]), i("p", [t._v("功能可能时不时会添加。")]), i("h2", [t._v("感谢")]), i("p", [t._v("本工具箱或多或少地参考了这些应用，它们也都是非常优秀的工具箱应用：")]), i("ul", [i("li", [i("a", {
                    attrs: {
